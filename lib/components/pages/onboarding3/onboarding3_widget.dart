import '/components/pages/onboarding4/onboarding4_widget.dart';
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/trewa-app-f7sza2/assets/sqde95d772v7/PERRITO-1-.png',
                                            width: 300.0,
                                            height: 230.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'Podrás agendar servicios con profesionales, encontrar a tu mascota perdida, incentivos y consejos de cuidado responsable',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge,
                                          ).animateOnPageLoad(animationsMap[
