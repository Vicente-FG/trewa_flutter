import '/components/pages/login/login_widget.dart';
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/trewa-app-f7sza2/assets/ht3a13mcqt9y/PERRITO-2.png',
                                            width: 300.0,
                                            height: 230.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'Y lo mejor de todo es que mientras más uses Trewa, más ayudas a animales vulnerables',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge,
                                          ).animateOnPageLoad(animationsMap[
