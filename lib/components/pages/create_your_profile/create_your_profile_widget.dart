...
class _CreateYourProfileWidgetState extends State<CreateYourProfileWidget> {
  ...
  void initState() {
    ...
    _model.userDniController ??= TextEditingController();
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Completa la información de tu perfil para completar la creación de tu cuenta.',
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 0.0),
                            child: TextFormField(
                              controller: _model.userDniController,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'RUT',
                                labelStyle:
                              ...
                              style: FlutterFlowTheme.of(context).headlineSmall,
                              validator: _model.userDniControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await currentUserReference!
                            ...
                            dni: _model.userDniController.text,
                          ));
                          Navigator.push(
                            context,
                            MaterialPageRoute(
