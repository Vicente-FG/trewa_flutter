...
import '/components/pages/create_your_profile/create_your_profile_widget.dart';
...
class _CreateDogProfileWidgetState extends State<CreateDogProfileWidget> {
  ...
  void initState() {
    ...
    _model.dogWeightController ??= TextEditingController();
  }
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: Image.asset(
                          'assets/images/subida_perro.png',
                        ).image,
                      ),
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 0.0),
                            child: TextFormField(
                              controller: _model.dogWeightController,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Peso de Perro',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                                      fontFamily: 'Inter',
                              ...
                              keyboardType: TextInputType.number,
                              validator: _model.dogWeightControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Puedes agregar multiples perros a tu perfil.',
                            style: FlutterFlowTheme.of(context).bodySmall,
                          ),
                        ],
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await DogsRecord.collection.doc().set({
                                ...createDogsRecordData(
                                  ...
                                  dogSize: _model.dogWeightController.text,
                                  dogBio: '',
                                ),
                                'dogPhoto': _model.uploadedFileUrls
                                    .map((e) => e)
                                    .toList(),
                              });
                              Navigator.pushAndRemoveUntil(
